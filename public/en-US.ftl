...
letter-student-disability-office =
    ...
    .description = When you need help getting Scribe for Meetings in the classroom, the disability office is the place to start. Be sure to give them as much advance notice. The disability office will need ample time to notify your instructor and get financial approval well before your classes begin.
    ...
    .body =
        ...
        But, I’ve located a solution. An accessibility product which displays shared slide shows in WCAG2.1 compliant HTML. The product is called, Scribe for Meetings.

        ## For me as a student, Scribe for Meetings will allow me to:
        ...
        ## For the instructor Scribe for Meetings will:
        ...
        You can find more information about Scribe for Meetings at { -product-link }

        After you’ve had a chance to look at Scribe for Meetings, I would like to schedule a time to discuss this in more detail with you. I think Scribe for Meetings is a reasonable accessibility accommodation for a problem with no solution until now.
...
letter-parent-teacher =
    ...
    .body =
        ...
        The product is called, Scribe for Meetings.

        ## Scribe for Meetings will allow { $childName } to:
        ...
        ## For you, Scribe for Meetings will:
        ...
        After you’ve had a chance to look at Scribe for Meetings, I’d like to schedule a time we could discuss how the school can obtain a license for it.

        I believe Scribe for Meetings qualifies as a reasonable accessibility accommodation. It’s also not cost prohibitive.
...
letter-parent-school-board =
    ...
    .body =
        ...
        ## Scribe for Meetings will allow my child to:
        ...
        ## For the teacher, Scribe for Meetings will:
        ...
        After you’ve had a chance to look at Scribe for Meetings, I would like to ask for agenda time to discuss this in more detail with the school board. Scribe for Meetings qualifies as a reasonable accessibility accommodation. It’s also not cost prohibitive.
...
letter-teacher-school-board =
    ...
    .body =
        ...
        ## Scribe for Meetings will allow my student to:
        ...
        ## For me, Scribe for Meetings will:
...
letter-employee-supervisor =
    ...
    .body =
        ...
        ## Scribe for Meetings will allow me to:
        ...
        ## For the team leader or presenter Scribe for Meetings will:
        ...
        There is more information about Scribe for Meetings at { -product-link }

        Scribe for Meetings is a simple and reasonable accessibility accommodation which is not cost prohibitive. Can you scan and review the information about Scribe for Meetings as soon as convenient? I’d like to schedule a time with you to discuss this in more detail.
...
letter-employee-hr =
    ...
    .body =
        ...
        The product I’m requesting, which solves this problem, is called Scribe for Meetings.

        Scribe for Meetings enables shared slide decks to be completely accessible to a screen reader or magnifier by converting content to WCAG2.1 compliant HTML.
        ...
        I’d like to schedule a time with you to discuss this in more detail. Scribe for Meetings is a reasonable accessibility accommodation which is not cost prohibitive.
...
letter-supervisor-hr =
    ...
    .description = This letter is for when an employee or team member of yours needs Scribe for Meetings for improved productivity or to do their job.
    ...
    .body =
        ...
        Until now, slide content presented through Zoom’s screen share has been inaccessible to screen readers and magnifiers. The product solving this issue is called, Scribe for Meetings.

        Scribe for Meetings enables shared slide decks to be completely accessible to a screen reader or magnifier by converting content to WCAG2.1 compliant HTML.

        ## Scribe for Meetings will allow my team member to:
        ...
        Scribe for Meetings seems a reasonable accessibility accommodation which is not cost prohibitive.
...
letter-member-church-staff =
    ...
    .body =
        ...
        ## As a congregational member, Scribe for Meetings will allow me to:
        ...
        ## For you and pastoral staff, Scribe for Meetings will:
        ...
        After you’ve had a chance to look at Scribe for Meetings, can we schedule a time to discuss this in more detail?

        I believe Scribe for Meetings is a reasonable accessibility accommodation for a problem with no solution until now.
...
letter-member-organization =
    ...
    .body =
        ...
        I think Scribe for Meetings is a simple and reasonable accessibility accommodation.
...
letter-event-attendee =
    ...
    .body =
        ...
        Would you review the information about Scribe for Meetings before the event? I’d be happy to make time in my schedule to discuss this in more detail, and the positive effect it will have for me during the event.

        I think you’ll agree, Scribe for Meetings is a pretty reasonable accessibility accommodation. Plus, it is not cost prohibitive.
